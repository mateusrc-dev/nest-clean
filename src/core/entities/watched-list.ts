export abstract class WatchedList<T> {
  public currentItems: T[] // current list values with removals, edits, additions
  private initial: T[] // initial elements of the list that will be the question or answer attachments
  private new: T[] // new ids that user add
  private removed: T[] // what attachments that user remove
